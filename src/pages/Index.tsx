      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4 py-16">
        ...
        >
          ...
          <p className="mx-auto max-w-xl text-lg text-muted-foreground">
            Your gateway to the decentralized world. Manage multiple cryptocurrencies
            with military-grade security, all from one beautiful interface.
          </p>
        </motion.div>
        ...
        >
          <Button
            size="lg"
            className="bg-primary text-primary-foreground px-8 py-6 text-lg glow-primary hover:bg-primary/90"
          ...
          <Button
            size="lg"
            variant="outline"
            className="border-primary/30 px-8 py-6 text-lg hover:bg-primary/10"
        ...
        {/* Feature Cards */}
        <motion.div
          className="grid max-w-4xl gap-6 md:grid-cols-3"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
